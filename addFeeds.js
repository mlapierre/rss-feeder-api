...
requirejs(['request', 'FeederStore', 'FeederCrawler', 'node-schedule', 'bunyan', 'Feed', 'Tag'],
function   (request, FeederStore, FeederCrawler, schedule, bunyan, Feed, Tag) {
