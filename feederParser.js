...
function (FParser, Q) {
  ...
  FeederParser.prototype.parse = function(res) {
    ...
    parser.on('meta', function(meta) {
      ...
      feed._id = "feed_" + res.request.uri.href;
      feed.type = "feed";
      feed.title = meta.title;
      feed.link = meta.link;
      feed.description = meta.description;
      feed.feed_link =  meta.xmlurl;
    ...
    parser.on('readable', function() {
      ...
      while (item = this.read()) {
        item.feed_id = "feed_" + res.request.uri.href;
        item.type = "article";
